...
- None of the original 9 actions remain open. Watch items: no `kind` (income/expense) column on categories; recurring expenses, receipts, and page transitions (#13/#14/#40) are still out of scope.
